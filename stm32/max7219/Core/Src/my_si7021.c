...
switch (i2c_alg) {
	...
	case 4:
		...
		TFTDrawUT32(48,54,GREEN,FONE,RH_Si,2,3);
		TFTDrawChar(96,54,GREEN,FONE,'%',3);
		TFTDrawUT32(48,80,GREEN,FONE,T_Si/10,2,3);
		TFTDrawChar(96,80,GREEN,FONE,'.',3);
		TFTDrawUT32(120,80,GREEN,FONE,T_Si%10,1,3);
		TFTDrawChar(144,80,GREEN,FONE,'C',3);
