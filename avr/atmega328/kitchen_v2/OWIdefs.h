...
/****************************************************************************
 ROM commands
****************************************************************************/
#define     OWI_ROM_READ    0x33    //!< READ ROM command code.//51
#define     OWI_ROM_SKIP    0xcc    //!< SKIP ROM command code.//204
#define     OWI_ROM_MATCH   0x55    //!< MATCH ROM command code.//85
#define     OWI_ROM_SEARCH  0xf0    //!< SEARCH ROM command code.//240
