...
static volatile u08 tft_orientation=3;
//-------------------FOR DMA--------------------------------
...
//--------------------------------------------------
void TFTDrawUT32_X(u16 x, u16 y, u16 color, u16 fone, u32 numeric, u08 digits,u08 size,char * mas) {
	CB(CS_TFT_PORT,CS_TFT_PIN);

	TrimConvertX(mas,numeric,digits);
	TFTDrawString(x,y,color,fone,mas,size);

	SB(CS_TFT_PORT,CS_TFT_PIN);
}
//--------------------------------------------------
void TFTDrawST32_X(u16 x, u16 y, u16 color, u16 fone, u32 numeric, u08 digits,u08 size,char * mas) {
	CB(CS_TFT_PORT,CS_TFT_PIN);
...
//--------------------------------------------------
void TFTDrawU32_X(u16 x, u16 y, u16 color, u16 fone, u32 numeric, u08 digits,u08 size,char * mas) {
	CB(CS_TFT_PORT,CS_TFT_PIN);
